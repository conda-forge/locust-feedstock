...
Once the `conda-forge` channel has been enabled, `locust, locust-with-all, locust-with-dns, locust-with-mqtt, locust-with-otel` can be installed with `conda`:

```
conda install locust locust-with-all locust-with-dns locust-with-mqtt locust-with-otel
```

or with `mamba`:

```
mamba install locust locust-with-all locust-with-dns locust-with-mqtt locust-with-otel
```
