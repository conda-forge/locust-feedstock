...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/locust-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4517&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/locust-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `locust` can be installed with:

```
conda install locust
```

It is possible to list all of the versions of `locust` available on your platform with:
